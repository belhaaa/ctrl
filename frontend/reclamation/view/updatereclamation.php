  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">The Controller</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../../../pages/tables.html">
            ...
            <span class="nav-link-text ms-1">Categorie reclamation</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../../pages/virtual-reality.html">
            ...
            <span class="nav-link-text ms-1">bibliotheque</span>
          </a>
        </li>
        <li class="nav-item">
		...
		<form action="" method="POST">
            <table align="center" class="table">
                ...
                <tr>
                    ...
                    <td><input type="text" name="level" id="level" maxlength="20" value = "<?php echo $categorie['level']; ?>"></td>
                </tr>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">The Controller</a>
                for a better web.
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://www.creative-tim.com" class="nav-link text-muted" target="_blank">The Controller</a>
                </li>
                <li class="nav-item">
